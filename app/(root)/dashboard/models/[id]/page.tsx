  ...
  return (
    <div className="mx-auto w-full max-w-[1080px] px-6 py-8 lg:px-8">
      ...
      {error ? (
        ...
        <p className="mt-6 text-[13px] text-zinc-500">Loading model…</p>
      ) : model === null ? (
        <p className="mt-6 text-[13px] text-zinc-500">This model could not be found.</p>
      ) : (
...
function ModelDetail({ model }: { model: CatalogueModel }) {
  return (
    <div className="mt-5">
      ...
      <p className="mt-4 w-full text-[15px] leading-relaxed text-zinc-400">
      ...
      <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
        <MetaCard label="Modalities">
          <span className="flex items-center gap-1.5">
            ...
            <ArrowRightIcon size={11} className="text-zinc-600" />
      ...
      <section className="mt-6">
        ...
        <div className="mt-3 rounded-xl border border-white/10 bg-[#0b0b0c] px-4 py-8 text-center text-[13px] text-zinc-500">
          Pricing coming soon.
        </div>
      </section>
    </div>
