    ...
    <section className="rounded-xl border border-white/10 bg-[#0b0b0c] p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <Link
          ...
          className="shrink-0 text-[13px] text-zinc-400 underline-offset-4 transition-colors hover:text-white hover:underline"
        >
          View more
        </Link>
      </div>
      ...
      <div className="mt-5">
        <div className="grid grid-cols-[1.25rem_minmax(0,1fr)_4rem_5.5rem] items-center gap-3 border-b border-white/5 pb-2 text-xs text-zinc-500">
          <span />
          <span>Model</span>
        ...
        <ol>
          ...
          {models.length === 0 ? (
            <li className="py-6 text-[13px] text-zinc-500">Nothing tagged yet.</li>
          ) : null}
        </ol>
      </div>
    </section>
