    ...
    <header className="sticky inset-x-0 top-0 z-50 border-b border-white/6 bg-black/70 backdrop-blur-md backdrop-saturate-150">
      <div className="relative flex h-14 items-center justify-between px-4 sm:h-16 sm:px-6 lg:px-10 xl:px-12">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <a
            href={`https://claude.ai/new?q=${ASK_AI_QUERY}`}
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Ask Claude about Orbit"
            className="flex size-8 items-center justify-center rounded-md border border-white/10 bg-white/[0.06] transition-colors hover:border-white/20 hover:bg-white/10"
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/vendors/anthropic.svg"
              alt=""
